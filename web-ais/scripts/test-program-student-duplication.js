...
assert.match(appSource, /const APPLICATION_RELEASE = Object\.freeze\(\{\s*version: "1\.7\.431"/u);
assert.match(authSource, /20260912-workflow-heading-cleanup-v1/u);
assert.match(indexSource, /20260912-workflow-heading-cleanup-v1/u);
