...
assert.match(appSource, /const APPLICATION_RELEASE = Object\.freeze\(\{\s*version: "1\.7\.422"/u);
assert.match(authSource, /20260910-general-expense-duplicate-payment-v1/u);
assert.match(indexSource, /20260910-general-expense-duplicate-payment-v1/u);
