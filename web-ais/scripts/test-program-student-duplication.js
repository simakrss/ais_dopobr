...
assert.match(appSource, /const APPLICATION_RELEASE = Object\.freeze\(\{\s*version: "1\.7\.436"/u);
assert.match(authSource, /20260913-dynamic-passport-ocr-v1/u);
assert.match(indexSource, /20260913-dynamic-passport-ocr-v1/u);
