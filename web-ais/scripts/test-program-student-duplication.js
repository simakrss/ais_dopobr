...
assert.match(appSource, /const APPLICATION_RELEASE = Object\.freeze\(\{\s*version: "1\.7\.423"/u);
assert.match(authSource, /20260910-table-numeric-nowrap-v1/u);
assert.match(indexSource, /20260910-table-numeric-nowrap-v1/u);
