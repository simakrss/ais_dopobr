...
assert.match(appSource, /const APPLICATION_RELEASE = Object\.freeze\(\{\s*version: "1\.7\.429"/u);
assert.match(authSource, /20260912-workflow-order-number-ymd-v1/u);
assert.match(indexSource, /20260912-workflow-order-number-ymd-v1/u);
