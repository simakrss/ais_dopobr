...
assert.match(appSource, /const APPLICATION_RELEASE = Object\.freeze\(\{\s*version: "1\.7\.408"/u);
assert.match(authSource, /20260909-settings-safe-rebase-v1/u);
assert.match(indexSource, /20260909-settings-safe-rebase-v1/u);
