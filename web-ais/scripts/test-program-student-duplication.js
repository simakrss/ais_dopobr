...
assert.match(appSource, /const APPLICATION_RELEASE = Object\.freeze\(\{\s*version: "1\.7\.419"/u);
assert.match(authSource, /20260909-student-application-date-v1/u);
assert.match(indexSource, /20260909-student-application-date-v1/u);
