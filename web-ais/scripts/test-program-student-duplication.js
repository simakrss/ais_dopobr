...
assert.match(appSource, /const APPLICATION_RELEASE = Object\.freeze\(\{\s*version: "1\.7\.434"/u);
assert.match(authSource, /20260913-mailbox-single-click-links-v1/u);
assert.match(indexSource, /20260913-mailbox-single-click-links-v1/u);
