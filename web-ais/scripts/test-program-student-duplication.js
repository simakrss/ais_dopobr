...
assert.match(appSource, /const APPLICATION_RELEASE = Object\.freeze\(\{\s*version: "1\.7\.441"/u);
assert.match(authSource, /20260913-document-photo-source-v1/u);
assert.match(indexSource, /20260913-document-photo-source-v1/u);
