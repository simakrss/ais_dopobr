...
assert.match(appSource, /const APPLICATION_RELEASE = Object\.freeze\(\{\s*version: "1\.7\.413"/u);
assert.match(authSource, /20260909-partner-settings-layout-v1/u);
assert.match(indexSource, /20260909-partner-settings-layout-v1/u);
