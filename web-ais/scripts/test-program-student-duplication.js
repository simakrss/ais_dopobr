...
assert.match(appSource, /const APPLICATION_RELEASE = Object\.freeze\(\{\s*version: "1\.7\.442"/u);
assert.match(authSource, /20260913-native-save-as-dialog-v1/u);
assert.match(indexSource, /20260913-native-save-as-dialog-v1/u);
