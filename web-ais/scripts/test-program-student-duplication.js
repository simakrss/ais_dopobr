...
assert.match(appSource, /const APPLICATION_RELEASE = Object\.freeze\(\{\s*version: "1\.7\.430"/u);
assert.match(authSource, /20260912-branded-document-save-dialogs-v1/u);
assert.match(indexSource, /20260912-branded-document-save-dialogs-v1/u);
