...
assert.match(appSource, /const APPLICATION_RELEASE = Object\.freeze\(\{\s*version: "1\.7\.414"/u);
assert.match(authSource, /20260909-document-workflow-v1/u);
assert.match(indexSource, /20260909-document-workflow-v1/u);
