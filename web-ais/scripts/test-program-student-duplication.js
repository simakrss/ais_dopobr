...
assert.match(appSource, /const APPLICATION_RELEASE = Object\.freeze\(\{\s*version: "1\.7\.403"/u);
assert.match(authSource, /20260908-commission-settings-v1/u);
assert.match(indexSource, /20260908-commission-settings-v1/u);
