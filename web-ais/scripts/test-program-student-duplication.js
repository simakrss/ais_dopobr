...
assert.match(appSource, /const APPLICATION_RELEASE = Object\.freeze\(\{\s*version: "1\.7\.433"/u);
assert.match(authSource, /20260912-local-documents-root-label-v1/u);
assert.match(indexSource, /20260912-local-documents-root-label-v1/u);
