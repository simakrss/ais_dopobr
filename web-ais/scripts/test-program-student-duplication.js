...
assert.match(appSource, /const APPLICATION_RELEASE = Object\.freeze\(\{\s*version: "1\.7\.415"/u);
assert.match(authSource, /20260909-import-enrollment-list-v1/u);
assert.match(indexSource, /20260909-import-enrollment-list-v1/u);
