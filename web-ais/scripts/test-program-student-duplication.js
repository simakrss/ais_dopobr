...
assert.match(appSource, /const APPLICATION_RELEASE = Object\.freeze\(\{\s*version: "1\.7\.438"/u);
assert.match(authSource, /20260913-person-note-date-shortcuts-v1/u);
assert.match(indexSource, /20260913-person-note-date-shortcuts-v1/u);
