...
assert.match(appSource, /const APPLICATION_RELEASE = Object\.freeze\(\{\s*version: "1\.7\.435"/u);
assert.match(authSource, /20260913-record-duplicate-confirmation-v1/u);
assert.match(indexSource, /20260913-record-duplicate-confirmation-v1/u);
