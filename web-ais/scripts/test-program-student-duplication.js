...
assert.match(appSource, /const APPLICATION_RELEASE = Object\.freeze\(\{\s*version: "1\.7\.440"/u);
assert.match(authSource, /20260913-recognition-result-button-right-v1/u);
assert.match(indexSource, /20260913-recognition-result-button-right-v1/u);
