...
assert.match(ocrCropperSource, /studentDocumentRecognitionCropViewState/u);
assert.match(ocrCropperSource, /const rotations = cropViewState\.rotations/u);
assert.match(ocrCropperSource, /const zooms = cropViewState\.zooms/u);
assert.match(ocrCropperSource, /rotations\.get\(currentPageKey\(\)\)/u);
assert.match(ocrCropperSource, /rotations\.set\(key, rotation\)/u);
assert.match(ocrCropperSource, /zooms\.get\(currentPageKey\(\)\)/u);
assert.match(ocrCropperSource, /zooms\.set\(currentPageKey\(\), zoom\)/u);
assert.match(ocrCropperSource, /fitDocumentPage\(restoredZoom, false\)/u);
assert.match(ocrCropperSource, /fitDocumentPage\(zoom, true\)/u);
assert.match(ocrCropperSource, /cropViewState\.lastDocumentKey = getStudentRecognitionFileKey\(file\)/u);
