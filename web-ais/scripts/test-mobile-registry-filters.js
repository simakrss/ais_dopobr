...
assert.match(stylesSource, /@media \(min-width: 721px\)[\s\S]*?\.collection-register \.section-head--headingless \.collection-primary-filters > \.search-box\s*\{[\s\S]*?flex:\s*1 1 320px;[\s\S]*?min-width:\s*260px;/u);
